...
export default function BookingPage() {
  ...
  if (sent) {
    ...
    return (
      <Layout title="Бронирование" description="Забронируйте домик на базе «Тепло» в Архызе. Домики в лесу, тишина и природа. Выберите даты — ответим в течение 30 минут.">
