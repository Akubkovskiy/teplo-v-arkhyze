...
const HOUSE_META = {
  ...
  3: {
    ...
    guests: "до 3 гостей",
    text: "Практичный вариант для пары или небольшой группы. Спальная зона, кухня, санузел, Wi‑Fi. Собственная парковка и тихая лесная локация в стороне от других домиков.",
    ...
    <Layout title="Домики" description="Домики базы «Тепло» в Архызе: от 34 до 40 м², на 2–6 гостей. В лесу, в стороне от посёлка. Wi-Fi, кухня, мангал, парковка.">
      ...
      <AnimatedSection className="card" style={{ marginTop: 14 }}>
        ...
        <ul>
          ...
          <li>Кухонная зона с посудой и плитой</li>
          <li>Мангальная зона и дрова</li>
          <li>Парковка у каждого домика</li>
          <li>Тихая лесная локация в стороне от трассы</li>
        </ul>
      </AnimatedSection>
