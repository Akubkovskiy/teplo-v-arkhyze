...
export default function ContactsPage() {
  return (
    <Layout title="Контакты и как добраться" description="Контакты базы «Тепло» в Архызе: телефон, Telegram, координаты для навигатора и ссылки на карты.">
      ...
      <AnimatedSection className="card" style={{ marginTop: 14 }}>
        <h3 style={{ marginTop: 0 }}>Расстояние от городов</h3>
        <ul>
          <li><b>Аэропорт Минеральные Воды:</b> ~200 км, около 2,5–3 ч</li>
          <li><b>Ставрополь:</b> ~260 км, около 3,5 ч</li>
          <li><b>Черкесск:</b> ~130 км, около 2 ч</li>
          <li><b>Краснодар:</b> ~430 км, около 5–6 ч</li>
          <li><b>Ростов-на-Дону:</b> ~380 км, около 5 ч</li>
        </ul>
        <p style={{ marginBottom: 0, opacity: 0.75, fontSize: "0.9em" }}>
          Регулярного общественного транспорта до базы нет — нужна своя машина или трансфер.
          Спросите нас, если нужна помощь с организацией трансфера из Черкесска или Минвод.
        </p>
      </AnimatedSection>
